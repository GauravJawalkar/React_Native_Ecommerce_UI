        ...
        <>
            ...
            <SafeAreaView className='h-screen bg-green-900 p-4 font-inter'>
                <View className='flex-1 justify-center items-center gap-5'>
                    ...
                    <Text className='font-inter text-4xl text-white'>Ecco_Web</Text>
                </View>
                <TouchableOpacity activeOpacity={0.7} className='mb-10'>
                    <Text className='capitalize font-inter border text-green-800 font-semibold bg-white py-3 px-4 rounded-lg text-center text-lg'>
                        Get Started
                    </Text>
                </TouchableOpacity>
            </SafeAreaView>
